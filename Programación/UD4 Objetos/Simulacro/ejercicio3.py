...
en_ambos = []
for jugador in atletico_madrid:
    for jugador_seleccion in seleccion_espanola:
        if jugador.nombre == jugador_seleccion.nombre:
            en_ambos.append(jugador)

print("Los jugadores del Atlético de Madrid que van a la Selección Española son:")
for juego in en_ambos:
    print(juego.nombre)
...
for jugador in atletico_madrid:
    for jugador_seleccion in seleccion_espanola:
        if jugador.nombre == jugador_seleccion.nombre and jugador.titular == jugador_seleccion.titular:
            ambos_titulares.append(jugador)

print("Los jugadores del Atlético de Madrid que van a la Selección Española y que son titulares en ambos equipos son:")

for jugador in ambos_titulares:
    print(jugador.nombre)



'''
van_seleccion = list(set(atletico_madrid) & set(seleccion_espanola))

print("Los jugadores del Atlético de Madrid que van a la Selección Española son:")

for jugador in van_seleccion:
    print(jugador.nombre)
