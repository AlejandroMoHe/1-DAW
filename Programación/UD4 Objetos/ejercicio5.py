...
ps4 = set(mejores_ps4)
xbox = set(mejores_xbox_x)

print("Los juegos que salieron en ambas plataformas son: ")
print("Los juegos que SOLO salieron en PS4 son: ")
print("Los juegos que SOLO salieron en XBOX X son: ")